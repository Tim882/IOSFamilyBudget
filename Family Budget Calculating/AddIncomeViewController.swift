...
class AddIncomeViewController: UIViewController {
    ...
    var categoryArray = ["Без названия", "Зарплата", "Дивиденды", "Бизнес", "Аренда", "Продажа", "Проценты по банковскому вкладу"]

    override func viewDidLoad() {
        super.viewDidLoad()
        
        self.view.backgroundColor = UIColor.white
        self.title = "Добавить доходы"
